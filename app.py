...
class ScreenerUnifiedFetcher:
    ...
    def process_company(self, symbol, name, start_year, end_year, download_type='all'):
        ...
        if download_type == 'all' or download_type == 'annual_reports':
        ...
        for link in all_links:
            ...
            if cat:
                # Check if this category should be downloaded based on download_type
                if download_type != 'all':
                    if download_type == 'ppt' and cat != 'PPT':
                        continue
                    if download_type == 'transcript' and cat != 'Transcript':
                        continue
